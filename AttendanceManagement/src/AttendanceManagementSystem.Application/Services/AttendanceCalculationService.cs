...
namespace AttendanceManagementSystem.Application.Services
{
    ...
    //                DateOnly actualCheckIn = record.FirstCheckInTime;
    ...
    //                //{
    //                //    EntryDay = record.Date,
    //                //    EmployeeCode = employeeCode,
    //                //    EmployeeFullName = employee.UserName,
    //                //    ScheduledStartTime = schedule.StartTime,
    //                //    FirstEntryTime = actualCheckIn,
    ...
    //        public Task<DateTime?> GetFirstEntryTimeForEmployeeByDayAsync(long employeeId, DateTime targetDate)
    //        {
    //            throw new NotImplementedException();
    //        }
    //    }
